...
class DDMMLightningModule(LightningModule):
    ...
    def _common_step(self, batch, batch_idx, optimizer_idx, stage: Optional[str]='common'): 
        ...
        pred_label_i = self.diffusion_from_image_to_label.forward(mid_i, timesteps).sample 
        pred_image_i = self.diffusion_from_label_to_image.forward(mid_l, timesteps).sample
